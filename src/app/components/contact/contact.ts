...
export class Contact {
  ...
  onSubmit(e: Event, form: any) {
    ...
    if (form.valid) {
      ...
      emailjs.sendForm('service_lpzbg65', 'template_pqhh288', e.target as HTMLFormElement, 'user_5VCPAeKnWXPuFf1EFz7mg')
        .then(() => {
      ...
      Object.values(form.controls).forEach(c => (c as AbstractControl).markAsDirty());
    }
  }
}
